    ...
    model(0)
{
    ...
    ui->addressIn_SM->setPlaceholderText(tr("Enter a Bitcoin address (e.g. LGrukM3adFibGZVyaqA35xtanUkHM3xxnV)"));
    ui->signatureOut_SM->setPlaceholderText(tr("Click \"Sign Message\" to generate signature"));

    ui->addressIn_VM->setPlaceholderText(tr("Enter a Bitcoin address (e.g. LGrukM3adFibGZVyaqA35xtanUkHM3xxnV)"));
